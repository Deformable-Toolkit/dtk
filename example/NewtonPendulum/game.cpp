...
void Game::Init()
{
    ...
    ResourceManager::GetShader("line").Use().SetInteger("line", 0);
    ...
    glm::vec2 ballPos = glm::vec2(this->Width / 2.0f + LINE_LEN - BALL_RADIUS,  2 * BALL_RADIUS);
    Ball = new BallObject(ballPos - glm::vec2(BALL_RADIUS,0), BALL_RADIUS,  ResourceManager::GetTexture("face"), INITIAL_BALL_VELOCITY + glm::vec2(20,0));
    // audio
